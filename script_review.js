	...
	*/
	...
	//document.getElementById('sliderAge').addEventListener("touchstart", touchHandler, false);
	//document.getElementById('containerRemark').addEventListener("touchstart", touchHandler, false);
	document.addEventListener("touchmove", touchHandler, false);
	//document.getElementById('sliderAge').addEventListener("touchmove", touchHandler, false);
	//document.getElementById('containerRemark').addEventListener("touchmove", touchHandler, false);
	document.addEventListener("touchend", touchHandler, false);
	//document.getElementById('sliderAge').addEventListener("touchend", touchHandler, false);
	//document.getElementById('containerRemark').addEventListener("touchend", touchHandler, false);
	...
	function getData() {
		...
		if(window.openDatabase) {
			...
			// If online, comapare versions for possible updates:
			if(navigator.onLine) {
			...
			database.transaction(function(tx) {
				...
				tx.executeSql(SQL, null, function(tx, resultSet) {
					for (var i=0; i<resultSet.rows.length;i++){
						...
						liRightObj.appendChild(liRightText);
						//liRightObj.appendChild(liRightTextA);
						liLeftObj.appendChild(liLeftText);
...
//alert('ok here, must be below');
					...
					// Move both containers from right to left
					//document.getElementById('containerAge').style.WebkitTransform= "translateX(-320px)";
					//document.getElementById('containerAge').style.visibility = "hidden";
					//document.getElementById('containerWeight').style.WebkitTransform= "translateX(-320px)";
					//document.getElementById('containerWeight').style.visibility = "hidden";
		...
		// If the user has touched the screen and moved the finger
			...
			if (e.touches.length == 1) {
				...
				//else if(sliderBool && (e.touches[0].target.id == "coverWeight" || e.touches[0].target.id == "coverAge")) {
					...
					//var targetSlider = e.touches[0].target.id;
					nX = touch.pageX;
									...
									//if(scrollX > 256) {
										...
										if(document.getElementById("sliderAge").style.webkitTransform == 0) {
											if (nX > oX) { // Left to right
												//document.getElementById("sliderWeight").style.webkitTransform = "translateX("+(scrollX).toString()+"px)";
												//document.getElementById("sliderAge").style.webkitTransform = "translateX("+(scrollX).toString()+"px)";
											...
											//document.getElementById("sliderWeight").style.left = scrollX.toString() + "px";
											//document.getElementById("sliderAge").style.left = scrollX.toString() + "px";
											} else { // Right to left
												document.getElementById("sliderWeight").style.webkitTransform = "translateX(-64px)";
												document.getElementById("sliderAge").style.webkitTransform = "translateX(-64px)";
												// Increment sliderPos
										...
										// If transform has been completed, get value and add to transform
											...
											//var px = document.getElementById("sliderAge").style.left.substring(0,document.getElementById("sliderAge").style.left.indexOf('px'));
											
											if (nX > oX) { // Left to right
												if(sliderPos != 1) {
													// Set new values
											//document.getElementById("sliderWeight").style.webkitTransform = "translateX("+(parseInt(px)+(scrollX)).toString()+"px)";
											//document.getElementById("sliderAge").style.webkitTransform = "translateX("+(parseInt(px)+(scrollX)).toString()+"px)";
											...
											//document.getElementById("sliderWeight").style.left = (parseInt(px)+(scrollX)).toString()+"px)";
											//document.getElementById("sliderAge").style.left = (parseInt(px)+(scrollX)).toString()+"px)";
										}
									}
									//alert('px current'=document.getElementById("sliderAge").style.webkitTransform;
									
									//document.getElementById("sliderAge").style.webkitTransform = "translateX(10px)";
	
									//alert('px translated='+px);
									//alert('deg='+(parseInt(px) + scrollX).toString() + "deg");
									//document.getElementById("sliderAge").style.webkitTransform = (parseInt(px) + scrollX).toString() + "px";
									//document.getElementById("sliderWeight").style.left = (parseInt(px) + scrollX).toString() + "px";
								//}
									touching = false;
					...
					/*if(document.getElementById("sliderAge").style.left == 0) {
						//alert('left=zero');
						document.getElementById("sliderAge").style.left = scrollX + "px";
						document.getElementById("sliderWeight").style.left = scrollX + "px";
					} else {
						var num = document.getElementById("sliderAge").style.left.substr(0,document.getElementById("sliderAge").style.left.indexOf('px'));
						//alert('left='+(parseInt(num) + scrollX).toString() + "px");
						document.getElementById("sliderAge").style.left = (parseInt(num) + scrollX).toString() + "px";
						document.getElementById("sliderWeight").style.left = (parseInt(num) + scrollX).toString() + "px";
					}*/
